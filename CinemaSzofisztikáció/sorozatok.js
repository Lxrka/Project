...
async function getSorozatok() {
    let kfn = new Set();
    let filmek = [];
    filmek = await fetch('http://localhost:8000/musor/sorozatok', {
        method: 'GET',
    })
    filmek = await filmek.json();
